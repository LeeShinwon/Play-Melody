...
struct CoverFlowList<Content: View, Item: RandomAccessCollection>: View where Item.Element: Identifiable {
    ...
    private nonisolated func rotation(_ proxy: GeometryProxy) -> Double {
